...
def create_batches_all():
    batches = []
    # ElementSquare
    batches.append(ElementwiseSquare({'prefix': ElementwiseSquare.__name__ + '_0_', 'dims': 1, 'minval': -1000, 'maxval': 1000}))
    batches.append(ElementwiseSquare({'prefix': ElementwiseSquare.__name__ + '_1_', 'dims': 1, 'minval': -0.5, 'maxval': 0.5}))
    # batches.append(ElementwiseSquare({'prefix': ElementwiseSquare.__name__ + '_2_', 'dims': 1, 'minval': -10.0, 'maxval': 10.0}))
    #
    # Rosenbrock
